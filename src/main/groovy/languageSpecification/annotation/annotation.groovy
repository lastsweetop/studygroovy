package languageSpecification.annotation
...
assert Bob.getAnnotation(languageSpecification.clz.Foo).value() == 'a'
...
assert Joe.getAnnotation(languageSpecification.clz.Foo).value() == 'a'
