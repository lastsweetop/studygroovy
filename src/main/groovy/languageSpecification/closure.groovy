...
println fib(10000)  // slow!

fib = { BigInteger n -> n.compareTo(new BigInteger(2)) > 0 ? n : fib(n.subtract(new BigInteger(1))) + fib(n.subtract(new BigInteger(2))) }.memoize()
println fib(10000) // fast!
